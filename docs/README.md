...
|-------|-------|-------------|
| 1 | [Getting Started](01-getting-started.md) | Installation, first launch, and menu bar overview |
| 2 | [Daily Workflow](02-daily-workflow.md) | Understanding the fixed schedule and starting sessions |
| 3 | [Task Management](03-task-management.md) | Adding, editing, and organizing your tasks |
...
- **New user?** Start with [Phase 1: Getting Started](01-getting-started.md)
- **Want to add tasks?** Jump to [Phase 3: Task Management](03-task-management.md)
- **Check your stats?** Go to [Phase 6: Statistics & Customization](06-statistics-customization.md)
